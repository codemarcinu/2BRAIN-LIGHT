...
def test_parse_receipt_with_openai_success(mock_env):
    with patch('openai.OpenAI') as MockOpenAI:
        ...
        mock_completion.choices[0].message.content = '{"date": "2023-01-01", "shop": "TestShop", "total": 10.0, "category": "Jedzenie"}'
        mock_client.chat.completions.create.return_value = mock_completion
        
        data = finanse.parse_receipt_with_openai("RAW TEXT")
        assert data['shop'] == "TestShop"
